...
export async function POST(req: NextRequest) {
  try {
    ...
    if (action === 'capture') {
      ...
      // The CAPI Gateway will automatically pick up the frontend Pixel event.
      // We do not fire a manual Graph API server event here to prevent duplicate server events.
