        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-zinc-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/about" className="text-sm text-zinc-600 hover:text-brand-800 transition-colors font-medium">Our Story</a></li>
              <li><a href="/behind-the-scenes" className="text-sm text-zinc-600 hover:text-brand-800 transition-colors font-medium">Behind The Scenes</a></li>
