...
export const PinkVelvetReviews: React.FC = () => {
  return (
    <div className="bg-[#111111] text-[#e8dfc8] font-light rounded-2xl overflow-hidden mt-12 mb-12 shadow-2xl">
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 py-8 px-6 border-b border-[#c9a84c22]">
        <div className="font-serif text-[52px] font-semibold text-[#c9a84c] leading-none">4.0</div>
        <div className="flex flex-col gap-1.5">
          <div className="text-[20px] text-[#c9a84c] tracking-widest">★★★★☆</div>
          <div className="text-[11px] tracking-[0.2em] text-[#c9a84c88] uppercase">Based on 3 reviews</div>
        </div>
        <div className="flex flex-col gap-1.5">
          {[
            { stars: 5, pct: "66%", count: 2 },
            { stars: 4, pct: "0%", count: 0 },
            { stars: 3, pct: "0%", count: 0 },
            { stars: 2, pct: "33%", count: 1 },
