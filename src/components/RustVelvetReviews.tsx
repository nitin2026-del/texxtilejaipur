...
const reviewsData = [
  {
    ...
    date: 'March 7, 2026',
    stars: 5,
    title: '"The most \'me\' jacket I\'ve ever bought"',
    body: 'That warm tobacco brown with the navy and gold embroidery is so rich and moody — unlike anything in my closet. The red striped lining peeking out is a perfect surprise. Absolutely love it.',
    reply: 'Beth, "rich and moody" is exactly the soul of this jacket! 🤎 So glad it feels like you. Thank you! 🙏'
  },
  {
    initial: 'F',
    name: 'Frances D.',
    ...
    date: 'May 29, 2026',
    stars: 2,
    title: '"Beautiful work but velvet showed wear quickly"',
    body: 'The embroidery is stunning and the colors are deep and rich. But after just a few wears the velvet started to show some flattening around the elbows. Expected more durability at this price point.',
    reply: 'Frances, thank you for this honest feedback. Velvet can flatten with friction over time — we recommend storing it hung and avoiding heavy bags on the shoulders. We\'re sorry it happened so soon and happy to help if you\'d like to discuss further. 🙏'
  }
];

export const RustVelvetReviews: React.FC<{ dynamicReviews?: ReviewData[] }> = ({ dynamicReviews = [] }) => {
  ...
  return (
    <div className="bg-[#111111] text-[#e8dfc8] font-light rounded-2xl overflow-hidden mt-12 mb-12 shadow-2xl">
      <div className="text-center py-12 px-6 border-b border-[#c9a84c33]">
        ...
        <p className="text-[12px] tracking-[0.25em] text-[#c9a84c88] uppercase">Verified Reviews · Rust Velvet Suzani Jacket</p>
      </div>
