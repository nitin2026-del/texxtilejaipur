...
const reviewsData = [
  {
    ...
    date: 'June 4, 2026',
    stars: 5,
    title: '"Bohemian luxury at its finest"',
    body: 'The velvet feels incredible, and the embroidery is so intricate. I wear this over simple slip dresses and it completely elevates the look. Truly an artisan piece.',
    reply: 'Clara, we love the slip dress idea! ✨ Thank you for recognizing the artisan craftsmanship. Wear it in good health! 🙏'
  },
  {
    initial: 'S',
    name: 'Sophia M.',
    ...
    date: 'May 12, 2026',
    stars: 4,
    title: '"Stunning colors, slightly snug fit"',
    body: 'The jewel tones are even better in person. The only reason it\'s not 5 stars is because the shoulders are a little tight on me. I\'d recommend sizing up if you want to layer it over thicker sweaters.',
    reply: 'Thank you for the helpful sizing note, Sophia! Since our jackets are hand-tailored, layering is always something to consider. Let us know if we can help with an exchange! 💛'
  },
  {
    initial: 'E',
    name: 'Elena R.',
    ...
    stars: 5,
    title: '"A masterpiece!"',
    body: 'I get stopped on the street every time I wear this jacket. The craftsmanship is undeniable. It feels like wearing a piece of history but with a modern, elegant twist.',
    reply: 'Being stopped on the street is the ultimate compliment! 🎉 We\'re thrilled it makes such a statement for you, Elena.'
  },
  {
    initial: 'O',
    name: 'Olivia K.',
    ...
    body: 'I hesitated because of the price, but the moment I unboxed it, I understood. The weight, the lining, the flawless stitching—it’s heirloom quality.',
    reply: '"Heirloom quality" is exactly what our artisans aim for. Thank you for trusting us with your investment, Olivia! 🤎'
  },
  {
    initial: 'H',
    name: 'Harper J.',
    ...
    date: 'January 9, 2026',
    stars: 4,
    title: '"Gorgeous but delicate"',
    body: 'Absolutely beautiful jacket. The velvet is super soft. You do have to be careful not to catch the embroidery on jewelry, but it’s a gorgeous statement piece.',
    reply: 'Great tip, Harper! Hand-embroidery does require a little extra care, but the statement is definitely worth it. Thank you! 🙏'
  }
];

export const BohemianEleganceReviews: React.FC<{ dynamicReviews?: ReviewData[] }> = ({ dynamicReviews = [] }) => {
  ...
  return (
    <div className="bg-[#111111] text-[#e8dfc8] font-light rounded-2xl overflow-hidden mt-12 mb-12 shadow-2xl">
      <div className="text-center py-12 px-6 border-b border-[#c9a84c33]">
        ...
        <p className="text-[12px] tracking-[0.25em] text-[#c9a84c88] uppercase">Verified Reviews · Artisan Bohemian Velvet Suzani</p>
      </div>
