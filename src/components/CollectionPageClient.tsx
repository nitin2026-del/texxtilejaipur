...
import { Filter, X, ShieldCheck, Truck, Undo2, Sparkles } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-emerald-50/50 border border-emerald-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-zinc-900 mb-2">Artisanal Commitment</h3>
              <p className="text-sm text-zinc-600">Please choose carefully. As an artisanal studio, we only accept returns for damaged or incorrect items within 3 days.</p>
            </div>
          </div>
        </div>
      </div>
